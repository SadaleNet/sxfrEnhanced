...
static bool mouse_scrollup = false, mouse_scrolldown = false;
			...
			switch (e.type) {
				...
				case SDL_KEYDOWN:
					...
					if(e.key.keysym.sym>='1'&&e.key.keysym.sym<='9')
						currentChannel = e.key.keysym.sym-'1';
				...
				case SDL_MOUSEBUTTONUP:
					switch (e.button.button){
						case SDL_BUTTON_WHEELUP: mouse_scrollup = true; break;
						case SDL_BUTTON_WHEELDOWN: mouse_scrolldown = true; break;
					}
				break;
